...
const $sql = require('./goodStudentSql');
...
//http://localhost:3000/api/goodStudent?studentId=1&goodStudent=1&howmuch=1500&title=学业一等奖
//http://localhost:3000/api/goodStudent?postId=1
//http://localhost:3000/api/goodStudent?classId=1&page=0&type=postId